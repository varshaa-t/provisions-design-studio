...
function Brands() {
  return (
    <div className='flex bg-black mt-10 -mx-12 overflow-auto scroll-container'>
        ...
        <img className='w-[50vw] sm:hidden md:block md:w-[33vw] xl:w-[25vw] border-zinc-700 border-r-[1px] h-auto hover:bg-white hover:bg-opacity-10 hover:duration-200' src={landau} alt='landau'/>
        <img className='w-[50vw] sm:hidden xl:block xl:w-[25vw] border-zinc-700 border-r-[1px] h-auto hover:bg-white hover:bg-opacity-10 hover:duration-200' src={suzuki} alt='suzuki'/>
    </div>
  )
}
